...
import { FaCode, FaGraduationCap, FaLightbulb, FaRunning, FaServer, FaTools, FaUtensils } from "react-icons/fa";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16 items-center">
          ...
          <div className="md:w-2/3">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-navy">About Dylan</h1>
            <div className="h-1 w-20 bg-orange mb-6"></div>
            <h2 className="text-2xl font-semibold mb-4">From Pizza Kitchens to Web Development</h2>
            <p className="text-lg mb-4">
              Growing up in the bustling atmosphere of a family-run pizza kitchen, I was immersed in a world where precision, creativity,
              and teamwork were paramount. These early experiences shaped my approach to problem-solving and collaboration in unexpected
              ways.
            </p>
            <p className="text-lg">
              After majoring in Computer Information Systems, I discovered how these same principles could be applied to technology. The
              transition felt natural - whether crafting the perfect pizza or building responsive web applications, the core elements of
              attention to detail, creativity, and user satisfaction remain the same.
            </p>
          </div>
        </div>
          ...
          <div className="md:w-8/12">
            ...
            <div className="mb-12 relative">
              ...
              <p className="text-lg mb-6">
                I specialize in full-stack development with a focus on creating accessible, performance-optimized web applications that
                solve real business problems. My technical toolkit includes:
              </p>
            ...
            <div className="mb-12 bg-white p-8 rounded-xl shadow-md relative overflow-hidden">
              ...
              <p className="text-lg mb-4 relative z-10">
                I believe that simplicity is the highest form of complexity. The most elegant solutions often appear simple on the surface,
                but that simplicity comes from a deep understanding of the underlying problem.
              </p>
              <p className="text-lg mb-4 relative z-10">When approaching complex technical challenges, I focus on:</p>
              <ul className="space-y-3 mb-4 relative z-10">
                <li className="flex items-start">
                  <span className="text-orange mr-2 mt-1">•</span>
                  <span>
                    <strong>Understanding the core problem</strong> before proposing solutions
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange mr-2 mt-1">•</span>
                  <span>
                    <strong>Breaking complex systems</strong> into manageable, modular components
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange mr-2 mt-1">•</span>
                  <span>
                    <strong>Prioritizing maintainability</strong> and scalability in all solutions
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange mr-2 mt-1">•</span>
                  <span>
                    <strong>Communicating clearly</strong> about technical concepts to stakeholders
                  </span>
                </li>
              </ul>
              <p className="text-lg relative z-10">
                This methodical approach to problem-solving has helped me deliver solutions that not only meet immediate needs but adapt and
            ...
            <div className="mb-12 relative">
              ...
              <p className="text-lg mb-6 relative z-10">When I&apos;m not building web applications, you&apos;ll find me:</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-orange">
                  ...
                  <p>
                    My background in a family pizza business gave me a love for cooking that continues today. I enjoy experimenting with new
                    recipes and techniques, applying the same creative problem-solving I use in development.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-navy">
                  ...
                  <p>
                    Physical fitness is an important part of maintaining mental clarity. Whether it&apos;s running, hiking, or strength
                    training, I find that regular exercise improves my problem-solving abilities and creativity.
                  </p>
                </div>
            ...
            <div className="sticky top-24">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden mb-6">
                <div className="bg-navy text-white p-6">
                  ...
                  <p className="text-sm opacity-80">Full-Stack Developer & IT Consultant</p>
                </div>
                <div className="p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-sm">Computer Information Systems</span>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-orange/20 p-2 rounded-full text-orange mr-3 mt-1">
                    ...
                    <div>
                      ...
                      <span className="text-sm">Full Stack Development, IT Consulting</span>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-orange/20 p-2 rounded-full text-orange mr-3 mt-1">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-sm">Web Applications, API Development</span>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 relative overflow-hidden">
                <h3 className="text-xl font-bold mb-4 text-navy relative z-10">Latest Insights</h3>
                <div className="space-y-4 relative z-10">
                  <Link href="/projects" className="block hover:bg-navy/5 p-3 rounded-lg transition">
                    <span className="text-orange font-medium">Projects</span>
                    <p className="text-navy">See recent development work and case studies</p>
                  </Link>
                </div>
              </div>
            </div>
