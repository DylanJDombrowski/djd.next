...
export const metadata: Metadata = {
  title: "Contact | Dylan J. Dombrowski",
  description:
    "Get in touch with Dylan J. Dombrowski for web development and IT consulting services.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-navy/80">Available upon request</p>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  href="https://dylandombro.substack.com/?r=sisxq&utm_campaign=pub-share-checklist&utm_source=dylanjdombrowski&utm_medium=website-contact"
                  target="_blank"
